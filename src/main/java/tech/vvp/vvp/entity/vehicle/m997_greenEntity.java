...
public class m997_greenEntity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, ArmedVehicleEntity {
    ...
    public m997_greenEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<m997_greenEntity>) packet.getEntityType(), world);
    }
    ...
    public void baseTick() {
        ...
        // Логика движения из удаленного метода travel()
    ...
    // Методы ArmedVehicleEntity - заглушки
